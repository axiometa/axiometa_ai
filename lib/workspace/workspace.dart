                ...
                for (var component in componentsInWorkspace) {
                  for (var connection in component.connections) {
                    ...
                    if (distanceToSegment(startPoint, endPoint, localPosition) < 5) {
                      ...
                      // Connection details for DHT11
                      String dht11Diagram =
                          '[DHT11]     [Arduino Nano]\n VCC    --> 5V\n Data   --> D2\n GND    --> GND\n';

                      // Connection details for BMP180
                      String bmp180Diagram =
                          '[BMP180]    [Arduino Nano]\n VCC    --> 3.3V\n SDA    --> A4\n SCL    --> A5\n GND    --> GND\n';

                      // Determine which diagram to display
                      String diagramText = component.name == "Sensor DHT11"
                          ? dht11Diagram
